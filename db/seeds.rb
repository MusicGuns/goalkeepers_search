...
@ice_palace = IcePalace.insert!({title: 'ВТБ Арена', adress: 'Ленинградский проспект, 36',
                 description: 'Многофункциональный спортивный комплекс в Москве, включающий в себя футбольную и хоккейную арену, построенный на месте снесённого стадиона «Динамо». Стадион под одной крышей объединяет две арены: Центральный стадион «Динамо» имени Льва Яшина и универсальную «ВТБ Арену» им. А. И. Чернышёва.', map_script: 'https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Ad428aca195d3a287bc1128928dcd4427a7dacb6cd660705285518c46034675cc&amp;width=320&amp;height=240&amp;lang=ru_RU&amp;scroll=true'}, record_timestamps: true)
@ice_palace = IcePalace.last
...
@ice_palace = IcePalace.insert!({title: 'Лужники', adress: 'улица Лужники, 24с1',
                 description: 'Второе после стадиона сооружение Олимпийского комплекса «Лужники», расположенное в его северо-западной части, крытая универсальная многофункциональная площадка со зрительным залом. ', map_script: 'https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A7ad55ce9dbeaccb379f1cd32b691342f09503df7fe2d7dea433f07157646cb9d&amp;width=320&amp;height=240&amp;lang=ru_RU&amp;scroll=true'}, record_timestamps: true)
@ice_palace = IcePalace.last
...
@ice_palace = IcePalace.insert!({title: 'Сокольники', adress: 'улица Сокольнический Вал, 1Бс2',
                 description: 'Дворец спорта «Сокольники» был открыт 14 апреля 1956 года на территории одноимённого парка культуры и отдыха. Изначально на месте нынешнего ДС находилась лишь хоккейная коробка, окружённая трибунами, под которыми находились помещения для спортсменов. По причине проведения в Москве соревнований по волейболу Универсиады-1973 арену было решено реконструировать, в результате чего над ней появилась крыша.', map_script: 'https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Aa0ffc419da4ef6018575b77a8136880e3f3dae70d6e4ede77afc043b465918ce&amp;width=320&amp;height=240&amp;lang=ru_RU&amp;scroll=true'}, record_timestamps: true)
@ice_palace = IcePalace.last
